export const sectionBankets = {
  sectionId: "banchete",
  sectionName: "Banchete",
  img: '/banchete.png',
  descriptionOne: 'Vă invităm să vă sărbătoriți evenimentul la PIZZA Ferma cu Origini - un loc unic unde puteți petrece un timp de neuitat alături de familia și prietenii tăi.',
